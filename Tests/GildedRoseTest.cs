...
namespace GildedRose.Tests
{
    ...
    class GildedRoseTest
    {
        ...
        {
            IList<Item> Items = new List<Item> { new Item { Name = "Backstage passes", SellIn = -1, Quality = 0 } };
            GildedRose app = new GildedRose(Items);
        ...
        {
            IList<Item> Items = new List<Item> { new Item { Name = "Normal Item", SellIn = -1, Quality = 55 } };
            GildedRose app = new GildedRose(Items);
            Assert.AreEqual(-2, Items[0].SellIn);
        ...
        {
            IList<Item> Items = new List<Item> { new Item { Name = "Normal Item", SellIn = 2, Quality = 2 } };
            GildedRose app = new GildedRose(Items);
